...
public class ModRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<ShapelessRepairRecipe>> SHAPELESS_REPAIR = RECIPE_SERIALIZERS.register("shapeless_repair", ShapelessRepairRecipe.Serializer::new);
