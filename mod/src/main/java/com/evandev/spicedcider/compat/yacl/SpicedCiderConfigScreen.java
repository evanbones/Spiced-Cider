    ...
    public static Screen create(Screen parent) {
        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .build())
                .categoryIf(ModList.get().isLoaded("betterclouds"), ConfigCategory.createBuilder()
                        .name(Component.translatable("category.spicedcider.betterclouds"))
                        .tooltip(Component.translatable("category.spicedcider.betterclouds.tooltip"))
                        .option(toggle("cloudShadows", client.cloudShadows))
                        .option(doubleSlider("cloudShadowStrength", client.cloudShadowStrength, 0.0, 1.0, 0.05))
                        .option(intSlider("cloudShadowSoftness", client.cloudShadowSoftness, 0, 64, 4))
                        .build())
